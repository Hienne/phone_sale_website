...
namespace bandienthoai.Areas.Admin.Controllers
{
    public class NguoiDungsController : Controller
    {
        ...
        {
            ViewBag.MaLND = new SelectList(db.LoaiNguoiDungs, "MaLND", "TenLoaiND");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNguoiDung,HoTen,TaiKhoan,MatKhau,DiaChi,Email,SDT,MaLND,GioiTinh,HinhAnh")] NguoiDung nguoiDung)
        {
            if (ModelState.IsValid)
            {
